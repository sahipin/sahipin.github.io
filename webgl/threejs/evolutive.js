...
function moveSphere() {
  ...
  var moveDistance = 20 * delta; // n pixels per second
  ...
  if (pressed['D'] || pressed['ARROWRIGHT']) {
	...
	luzFocalBall.position.set(sphereBody.position.x, sphereBody.position.y, sphereBody.position.z-0.5);
